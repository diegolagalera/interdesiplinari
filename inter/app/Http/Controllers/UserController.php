...
class UserController extends Controller {
    ...
    public function __construct() {
        $this->middleware(['auth', 'isAdmin', 'clearance'])->except('registre','verify','show'); //isAdmin middleware lets only users with a //specific permission permission to access these resources
    }
