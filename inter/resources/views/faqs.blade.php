...
<div id="contenedor" class="container-fluid bg-3 text-center">
        ...
        <br><br>
        <h3 id="btn" onclick="checkClick('#faq1')" class="select">Que lugar es este?</h3>
        <h5 id="faq1">BAXKids es una web donde vendemos unos servicio de corte de pelo y productos los cuales se reservan por la web y se recogen y pagan en la tienda físicamente.</h5>
        <br>
